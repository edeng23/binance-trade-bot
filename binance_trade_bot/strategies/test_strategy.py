...
class Strategy(AutoTrader):
    ...
    def scout(self):
        ...
        print(
            ...
            f"{Fore.CYAN}bullish{Style.RESET_ALL} " if not self.panicked and (self.sar > self.Res_mid or self.rv_rsi > 50) else f"",
            f"{Fore.CYAN}bearish{Style.RESET_ALL} " if self.panicked and (self.sar < self.Res_mid or self.rv_rsi < 50) else f"",
