...
Create a .ini file named `user.cfg` based off `.user.cfg.example` and `supported_coin_list` based off `.supported_coin_list.example`, then add your API keys and current coin.
