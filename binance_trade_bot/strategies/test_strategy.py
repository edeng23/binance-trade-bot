...
class Strategy(AutoTrader):
    ...
    def scout(self):
        ...
        print(
            ...
            f"{Fore.CYAN}bullish{Style.RESET_ALL} " if not self.panicked and self.sar > self.Res_mid and self.rv_rsi > 50 else f"{Fore.CYAN}bearish{Style.RESET_ALL} ",
            f"{Fore.CYAN}bearish{Style.RESET_ALL} " if self.panicked and self.sar < self.Res_mid and self.rv_rsi < 50 else f"{Fore.CYAN}bullish{Style.RESET_ALL} ",
            f"{round(self.sar, self.d)} ",
