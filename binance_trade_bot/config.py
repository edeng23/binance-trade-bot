...
class Config:
    def __init__(self):
        ...
        self.SCOUT_MULTIPLIER = float(os.environ.get('SCOUT_MULTIPLIER') or config.get(
            USER_CFG_SECTION, 'scout_multiplier'))
        self.SCOUT_SLEEP_TIME = int(os.environ.get('SCOUT_SLEEP_TIME') or config.get(
